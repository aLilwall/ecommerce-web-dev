...
let products = [
    ...
    {id: 3, name: 'Parfum - clair obscur', price: 35, image: imgPath+'/perfume-3-front.webp', selected: imgPath+'/perfume-3-selected.webp', page: pagePath+'/third_page.html'},
    ...
    {id: 7, name: 'Parfum - Perkus', price: 40, image: imgPath+'/perfume-7-front.webp', selected: imgPath+'/perfume-7-selected.webp', page: pagePath+'/seventh_page.html'},
    ...
    {id: 9, name: 'Parfum - Harusos', price: 40, image: imgPath+'/perfume-9-front.webp', selected: imgPath+'/perfume-9-selected.webp', page: pagePath+'/ninth_page.html'},
    ...
    {id: 12, name: 'Parfum - Taranis', price: 60, image: imgPath+'/perfume-12-front.webp', selected: imgPath+'/perfume-12-selected.webp', page: pagePath+'/twelfth_page.html'},
]
